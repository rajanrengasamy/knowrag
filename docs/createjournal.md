...
2. **Read existing context** - Check `/journal.md` (if exists), `/tasks/tasks-knowrag-phase1.md`, and `/docs/PRD-v2.md` for continuity
...
- **PRD:** `/docs/PRD-v2.md` - Product requirements document
- **Tasks:** `/tasks/tasks-knowrag-phase1.md` - Implementation task list
- **Journal:** `/journal.md` - Session history (project root)
